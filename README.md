...
## 📥 ダウンロード
右側の **[Releases]** セクション、または [こちらのリリースページ](https://github.com/iamsam174/SwitchBotPlugMini_Eye/releases/latest) から、最新の **zipファイル** と **かんたんガイド(PDF)** をダウンロードできます。
ダウンロードした **zipファイル** を解凍すれば、アプリ **exeファイル** が使えるようになります。
